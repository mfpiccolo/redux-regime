...
var BaseQuery = function () {
  ...
  _createClass(BaseQuery, null, [{
    ...
    value: function query(resources) {
      return new QueryObject((0, _pluralize2.default)(this.name.toLowerCase()), resources, this.hasMany);
    }
  }]);
...
var QueryObject = exports.QueryObject = function () {
  function QueryObject(resourceName, resources) {
    ...
    var hasManyRelationships = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
