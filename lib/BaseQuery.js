  ...
  _createClass(BaseModel, null, [
    {
      ...
      value: function query(resources) {
        return new QueryObject(
          (0, _pluralize2.default)(this.name.toLowerCase()),
          resources,
          this.hasMany
        );
      }
...
var QueryObject = (exports.QueryObject = (function() {
  function QueryObject(resourceName, resources) {
    ...
    var hasManyRelationships = arguments.length > 2 &&
    ...
    hasManyRelationships.forEach(function(relationship) {
      QueryObject.prototype[relationship] = function() {
        _this.resourceName = relationship;
        return _this;
      };
    });
  }
  ...
  _createClass(QueryObject, [
    ...
    },
    {
      ...
      value: function whereRelated(relationship, params) {
        ...
        this.currentResources = relationship
          ...
          .execute()
          .reduce(function(newResource, relatedResource) {
      ...
      value: function execute() {
        ...
        return Object.values(currentResources).map(function(_ref2) {
          ...
          return _extends(
            ...
            _flattenRelationships(relationships).reduce(function(
              nextRelationshipObjects,
              _ref3
            ) {
              var id = _ref3.id, type = _ref3.type;
              ...
              if (!_this2.resources[type]) return nextRelationshipObjects;
              var relationData = _this2.resources[type][id];
    ...
    },
    {
      ...
      value: function _flattenRelationships(relationships) {
        return Object.values(relationships).reduce(function(
          nextRelationships,
          _ref4
        ) {
          var data = _ref4.data;
          ...
          return [].concat(
            _toConsumableArray(nextRelationships),
    ...
    },
    {
      ...
      value: function _filterAndSetCurrentResourcesByParams(params) {
        ...
        var resourcesByID = Object.entries(
          this.currentResources
        ).reduce(function(newResource, _ref5) {
    ...
    },
    {
      ...
      value: function _filterResourceByParams(
        params,
        newResource,
        resource,
        id
